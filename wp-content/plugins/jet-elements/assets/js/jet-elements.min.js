! function(j, f) {
    ...
    var u = {
        ...
        widgetCountdown: function(s) {
            var a, n = s.find(".jet-countdown-timer"),
                t = n.data("type"),
                o = null,
                i = n.data("due-date"),
                r = n.data("start-date"),
                e = n.data("expire-actions"),
                l = n.data("evergreen-interval"),
                d = n.data("restart-interval"),
                c = {
            ...
            u.widgetCountdown.initClock = function() {
                ...
                function e() {
                    var e = new Date,
                        t = e.setSeconds(e.getSeconds() + l);
                    return localStorage.setItem(i, t), localStorage.setItem(a, l), t
                }
                var t = s.data("id"),
                    i = "jet_evergreen_countdown_due_date_" + t,
                    a = "jet_evergreen_countdown_interval_" + t,
            ...
            function t() {
                ...
                h.validateEmail(e) ? (j.each(t, function(e, t) {
                    ...
                    success: function(e) {
                        ...
                        m.removeClass("loading"), l = !0, n.removeClass("jet-subscribe-form--response-error"), n.addClass(a), j("span", g).html(i), g.css({
                            visibility: "visible"
                        }), setTimeout(function() {
                            g.css({
                                visibility: "hidden"
                ...
                })) : (c.addClass("mail-invalid"), n.addClass("jet-subscribe-form--response-error"), j("span", g).html(p), g.css({
                    visibility: "visible"
                }), setTimeout(function() {
                    n.removeClass("jet-subscribe-form--response-error"), g.css({
                        visibility: "hidden"
        ...
        widgetSlider: function(e) {
            ...
            if (a.length) {
                ...
                var o = "" !== i.sliderHeightTablet.size ? i.sliderHeightTablet.size + i.sliderHeightTablet.unit : i.sliderHeight.size + i.sliderHeight.unit,
                    ...
                    m = void 0 !== f.config.breakpoints.md ? f.config.breakpoints.md - 1 : 767,
                    g = {};
                f.isEditMode() && (m -= 17), g[u] = {
                    ...
                    init: function() {
                        var e = j("." + i.sliderFullscreenIcon).html(),
                            t = j("." + i.sliderNavigationIcon).html();
        ...
        widgetTestimonials: function(e) {
            var t = e.find(".jet-testimonials__instance"),
                i = (j(".jet-testimonials__figure", t), t.data("settings"));
        ...
        widgetHorizontalTimeline: function(s) {
            ...
            "ontouchstart" in window || "ontouchend" in window ? e.on("touchend.jetHorTimeline", function(e) {
                ...
                "next" == t && h < w[i] && (f -= v[i], h += 1), "prev" == t && 0 < h && (f += v[i], h -= 1), 0 < h ? l.removeClass("jet-arrow-disabled") : l.addClass("jet-arrow-disabled"), h === w[i] ? r.addClass("jet-arrow-disabled") : r.removeClass("jet-arrow-disabled"), 0 === h && (f = 0), n.css({
                ...
                function t() {
                    l.addClass("jet-arrow-disabled"), r.hasClass("jet-arrow-disabled") && r.removeClass("jet-arrow-disabled"), 0 === w[i] && r.addClass("jet-arrow-disabled"), h = f = 0, n.css({
    ...
    window.jetAnimatedText = function(e, n) {
        ...
        jQuery.extend(jQuery.easing, {
            ...
            t = f[e].offset - l.offset, d || (d = !0, window.history.pushState(null, null, "#" + e), s = e, o.removeClass("active"), i.addClass("active"), o.removeClass("invert"), f[e].invert && o.addClass("invert"), a.animate({
                scrollTop: t
            ...
            var e = h.mobileAndTabletcheck(),
                m = 0;
            l.sectionSwitch && (e || document.addEventListener("wheel", g.onWheel, {
                passive: !1
            }), e && l.sectionSwitchOnMobile && (document.addEventListener("touchstart", function(e) {
        ...
        r.init = function() {
            ...
            j(".jet-parallax-section__layout", v).remove(), j.each(t, function(e, t) {
                var i, a, n = t.jet_parallax_layout_image,
                    ...
                    f = "MacIntel" == y ? " is-mac" : "";
                if ("" === n.url && !p) return !1;
                v.hasClass("jet-parallax-section") || v.addClass("jet-parallax-section"), i = j('<div class="jet-parallax-section__layout elementor-repeater-item-' + g + " jet-parallax-section__" + u + "-layout" + f + '"><div class="jet-parallax-section__image"></div></div>').prependTo(v).css({
                    "z-index": s
                });
                var h = {
                    "background-size": r,
